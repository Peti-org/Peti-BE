...
-- 1. location
INSERT INTO location (location_id, longitude, latitude, country, city, address) VALUES
(1, 30.5234, 50.4501, 'Ukraine', 'Kyiv', '{"street": "Khreshchatyk", "building": "22", "zip": "01001"}'),
(2, 24.0297, 49.8397, 'Ukraine', 'Lviv', '{"street": "Rynok Square", "building": "1", "zip": "79000"}'),
(3, 35.0462, 48.4647, 'Ukraine', 'Dnipro', '{"street": "Yavornytskoho Ave", "building": "50", "zip": "49000"}');

-- 2. user
-- Assume passwords here are placeholders (in reality, store hashes)
INSERT INTO "user" (user_id, first_name, last_name, email, birthday, password, location_id, user_is_deleted, user_data_folder) VALUES
('a1b2c3d4-e5f6-7890-1234-567890abcdef', 'Ivan', 'Petrenko', 'ivan.p@example.com', '1990-05-15', 'hashed_password_1', 1, false, '/data/users/ivan_p'),
('b2c3d4e5-f6a7-8901-2345-67890abcdef0', 'Olena', 'Kovalenko', 'olena.k@example.com', '1988-11-20', 'hashed_password_2', 2, false, '/data/users/olena_k'),
('c3d4e5f6-a7b8-9012-3456-7890abcdef01', 'Serhiy', 'Melnyk', 'serhiy.m@example.com', '1995-02-10', 'hashed_password_3', 1, false, '/data/users/serhiy_m'),
('d4e5f6a7-b8c9-0123-4567-890abcdef012', 'Maria', 'Shevchenko', 'maria.s@example.com', '1992-09-01', 'hashed_password_4', 3, true, '/data/users/maria_s'); -- Deleted user
