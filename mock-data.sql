...
-- 1. city
INSERT INTO city (city_id, longitude, latitude, country, country_code, city, location_info) VALUES
...
INSERT INTO "user" (user_id, first_name, last_name, email, birthday, password, location_id, city_id, user_is_deleted, user_data_folder, role_id) VALUES
('a1b2c3d4-e5f6-7890-1234-567890abcdef', 'Ivan', 'Petrenko', 'ivan.p@example.com', '1990-05-15', 'hashed_password_1', 1, 1, false, '/data/users/ivan_p', 4),
('b2c3d4e5-f6a7-8901-2345-67890abcdef0', 'Olena', 'Kovalenko', 'olena.k@example.com', '1988-11-20', 'hashed_password_2', 2, 2, false, '/data/users/olena_k', 3),
('c3d4e5f6-a7b8-9012-3456-7890abcdef01', 'Serhiy', 'Melnyk', 'serhiy.m@example.com', '1995-02-10', 'hashed_password_3', 1, 1, false, '/data/users/serhiy_m', 2),
('d4e5f6a7-b8c9-0123-4567-890abcdef012', 'Maria', 'Shevchenko', 'maria.s@example.com', '1992-09-01', 'hashed_password_4', 3, 3, true, '/data/users/maria_s', 4), -- Deleted user
('7dc587a7-9ab7-472b-b3b6-6702c4f8a680', 'Tester', 'Testenov', 'tester@gmail.com', '2000-06-16', '$2a$10$DxZ/I/5twj09Mte7Q/W.ceJnZF5o3eg0PRUTMlucttSHAWysuN0Rm', null, 1, false, 'default', 1);
