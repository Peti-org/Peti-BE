...
public record CaretakerPreferences(
    ...
    //todo need to be deprecate and deleted and used rrules isnstead of this
  ...
  public record ServiceConfig(
      ...
      int maxSimultaneousPets,//todo it must be fixed for some services like grooming
      ...
      @Valid
      Map<String, PetConfig> configs,//todo far all Map with Strings ut must be enum instead of String
