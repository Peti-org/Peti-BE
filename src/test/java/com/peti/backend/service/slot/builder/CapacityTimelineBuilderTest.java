...
class CapacityTimelineBuilderTest {
  ...
  void singleRRule_noBookings() {
    ...
    assertThat(segments.getFirst().timeFrom()).isEqualTo(LocalDateTime.of(DATE, LocalTime.of(8, 0)));
    assertThat(segments.getFirst().timeTo()).isEqualTo(LocalDateTime.of(DATE, LocalTime.of(20, 0)));
    assertThat(segments.getFirst().capacity()).isEqualTo(3);
  }
  ...
  void overlappingRRules() {
    ...
    assertThat(segments.getFirst().capacity()).isEqualTo(3);
    assertThat(segments.getFirst().timeFrom()).isEqualTo(LocalDateTime.of(DATE, LocalTime.of(8, 0)));
    assertThat(segments.getFirst().timeTo()).isEqualTo(LocalDateTime.of(DATE, LocalTime.of(18, 0)));
